    ...
    : QMainWindow(parent)
{
    ...
    // tool menu
    mainToolBar->addAction(QIcon("Resources/play.gif"), "Play VM", this, SLOT(play_machine()));
    mainToolBar->addAction(QIcon("Resources/pause.gif"), "Pause VM", this, SLOT(pause_machine()));
    mainToolBar->addAction(QIcon("Resources/stop.gif"), "Stop VM", this, SLOT(stop_machine()));
